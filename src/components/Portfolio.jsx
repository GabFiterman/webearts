  ...
  return (
    <div className="Portfolio__highlight">
      {porfolioData
        ...
        .map((project, index) => (
          <div key={project.id} className={`Portfolio__highlight--card ${index === 0 ? "card1" : "card2"}`}>
              <div className="Portfolio__highlight--card--heading">
                  ...
                  />
                  <h3 className="title Portfolio__highlight--heading--title">{project.company.name}</h3>
              </div>
              <img
...
export default function Portfolio() {
  const highlihtProjects = ["Go Best Life", "ByShop"];
  const astronautTouchMeSrc = '/public/img/astronauts/Astronaut_Genial+Switch-Aceso.png'
    ...
    <div className="Portfolio">
      <div className="d-flex align-items-center justify-content-between">
        ...
        <div className="d-flex align-items-center">
          <img className="Portfolio--image--badge" alt="Astronauta clique-me" src={badgeTouchMeSrc}/>
          <img className="Portfolio--image--astronaut" alt="Astronauta clique-me" src={astronautTouchMeSrc}/>
        </div>
      </div>
